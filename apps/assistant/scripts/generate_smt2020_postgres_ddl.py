...
GENERAL_DATA_DIR = APP_ROOT / "data" / "smt2020" / "General Data"
OUTPUT_PATH = APP_ROOT / "sql" / "postgresql" / "010_create_smt2020_fab_staging_schemas.sql"
...
def main() -> None:
    ...
    for dataset_dir, schema_name, workbook_name in DATASETS:
        ...
        lines.append(f"-- {dataset_dir} -> {schema_name}: {workbook_path.relative_to(PROJECT_ROOT)}")
